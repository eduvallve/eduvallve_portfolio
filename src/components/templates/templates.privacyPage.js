const PrivacyPage = () => {
    return (
        <main className="privacy">
            ...
            <section>
            <h2>4. How I use personal data</h2>
            ...
            <p>I may share personal data with trusted third-party processors who perform services on my behalf (for example: hosting providers, analytics, or contact form services). These processors act under contract and only process data according to my instructions.</p>
            <p>Typical categories of processors include:</p>
            <ul>
                <li>Hosting and deployment (e.g., GitHub Pages, Netlify, Vercel, or similar)</li>
                <li>Analytics providers (e.g., Google Analytics — if enabled)</li>
                <li>Email / contact form processors (e.g., Formspree, SendGrid, or your chosen provider)</li>
            </ul>
            ...
            <ul>
                ...
                <li>Preferences and performance (to remember settings).</li>
                <li>Analytics (if enabled) for aggregate usage statistics).</li>
            </ul>
            <p>You can manage or disable cookies using your browser settings. If analytics cookies are used, they will be enabled only after you give clear consent (where required).</p>
            </section>

            <section>
            <h2>7. Transfers outside the EEA</h2>
            <p>Some third-party processors may transfer or store data outside the European Economic Area (EEA). Where transfers occur, I will ensure appropriate safeguards are in place (standard contractual clauses, adequacy decisions, or other lawful mechanisms) to protect your data in accordance with the GDPR.</p>
            </section>
            ...
            <section>
            <h2>9. Your rights</h2>
            <p>Under the GDPR (and other applicable laws) you may have the right to:</p>
            <ul>
                <li>Access the personal data I hold about you.</li>
                <li>Request correction of inaccurate or incomplete data.</li>
                <li>Request deletion ("right to be forgotten") where there is no lawful reason for continued processing.</li>
            ...
            <p>If you believe your data protection rights have been violated, you have the right to file a complaint with your local data protection authority. For EU residents, the lead authority depends on your member state; for example:</p>
            <ul>
            ...
            <section>
            <h2>11. Security</h2>
            <p>I implement reasonable technical and organizational measures to protect personal data. However, no system is completely secure — if a breach occurs I will comply with applicable laws and notify affected individuals and authorities when required.</p>
            </section>

            <section>
            <h2>12. Children</h2>
            <p>The Site is not directed to children under 16. I do not knowingly collect personal data from children. If you believe I have collected personal data from a child, please contact me to request deletion.</p>
            </section>

            <section>
            <h2>13. Changes to this policy</h2>
            <p>I may update this Privacy Policy from time to time. When changes are material, I will provide a more prominent notice (for example, banner or email where appropriate) and update the "Last updated" date above.</p>
            </section>
